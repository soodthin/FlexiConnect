...
const JobMap = ({ job }) => {
  ...
  if (isLoading) {
    return (
      <>
        <div className={`flex items-center justify-between p-4 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gradient-to-r from-blue-50 to-indigo-100 border-gray-200'} border-b`}>
          <div className="flex items-center space-x-3">
            <MapPin className={`w-5 h-5 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} />
            <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Đang tải bản đồ...</span>
          </div>
          <button
            onClick={toggleDarkMode}
            className={`p-2 rounded-lg transition-all duration-300 ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600 text-yellow-400' : 'bg-white hover:bg-gray-50 text-gray-600'} shadow-sm`}
          >
            {isDarkMode ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
          </button>
        </div>

        <div className={`flex flex-col items-center justify-center h-[400px] ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
          ...
          <p className={`mt-3 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} text-sm`}>Đang định vị...</p>
        </div>
      </>
    );
  }
  ...
  if (error) {
    return (
      <>
        <div className={`flex items-center justify-between p-4 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gradient-to-r from-red-50 to-pink-100 border-gray-200'} border-b`}>
          <div className="flex items-center space-x-3">
            <MapPin className={`w-5 h-5 ${isDarkMode ? 'text-red-400' : 'text-red-600'}`} />
            <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Lỗi bản đồ</span>
          </div>
          <button
            onClick={toggleDarkMode}
            className={`p-2 rounded-lg transition-all duration-300 ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600 text-yellow-400' : 'bg-white hover:bg-gray-50 text-gray-600'} shadow-sm`}
  ...
  if (!position) {
    return (
      <>
        <div className={`flex items-center justify-between p-4 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gradient-to-r from-gray-50 to-gray-100 border-gray-200'} border-b`}>
          <div className="flex items-center space-x-3">
            <MapPin className={`w-5 h-5 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`} />
            <span className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Không có vị trí</span>
          </div>
          <button
            onClick={toggleDarkMode}
            className={`p-2 rounded-lg transition-all duration-300 ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600 text-yellow-400' : 'bg-white hover:bg-gray-50 text-gray-600'} shadow-sm`}
        ...
        <div className={`flex items-center justify-center h-[400px] ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
          <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-sm`}>Không thể hiển thị bản đồ</p>
        </div>
      </>
    );
  }
    ...
    <>
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4">
          <div className="w-full max-w-6xl bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
            <div className={`flex items-center justify-between p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gradient-to-r from-blue-50 to-indigo-100 border-gray-200'} border-b`}>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Vị trí công việc</h3>
                  <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>{job.location || 'Vị trí không xác định'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <select
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-medium ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-700'} border border-gray-300`}
                >
                ...
                <button onClick={toggleFullscreen} className={`p-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-white text-gray-600'}`}>
        ...
        <div className={`flex items-center justify-between p-4 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gradient-to-r from-blue-50 to-indigo-100 border-gray-200'} border-b`}>
          ...
          <div className="flex items-center space-x-2">
            <div className="relative">
              ...
              <Layers className={`absolute right-2 top-1/2 transform -translate-y-1/2 w-3 h-3 pointer-events-none ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                }`} />
            </div>
          ...
          >
            ...
            <Marker position={position}>
              <Popup className="custom-popup">
                <div className={`font-sans p-3 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'} rounded-lg min-w-[280px]`}>
                  <div className="flex items-start space-x-3 mb-4">
                    <div className={`p-2 rounded-lg ${isDarkMode ? 'bg-blue-500/20' : 'bg-blue-100'} flex-shrink-0`}>
                      <MapPin className={`w-5 h-5 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} />
                    </div>
                    <div className="flex-1">
                      <h4 className={`font-bold text-base ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-1`}>
      ...
      {/* Footer Info */}
      {!isFullscreen && (
        <div className={`px-4 py-3 ${isDarkMode ? 'bg-gray-800/50' : 'bg-gray-50'} border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <Layers className={`w-3 h-3 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Đã tải</span>
            </div>
          </div>
        </div>
      )}
